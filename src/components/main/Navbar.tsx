    ...
    <div className="w-full h-[65px] fixed top-0 shadow-lg shadow-[#2A0E61]/20 bg-[#030014]/80 backdrop-blur-xl z-50 px-2 lg:px-10 border-b border-[#ffffff10]">
      <div className="w-full h-full flex flex-row items-center justify-between m-auto px-[10px]">
        ...
        <div className="flex flex-row gap-6 text-gray-300 items-center">
            <div className="cursor-pointer hover:text-white transition-colors relative">
               <Search className="w-5 h-5" />
            </div>
            <div className="cursor-pointer hover:text-pink-500 transition-colors relative">
               <Heart className="w-5 h-5" />
            </div>
            <div className="cursor-pointer hover:text-white transition-colors relative group">
               <ShoppingBag className="w-5 h-5" />
               <span className="absolute -top-1.5 -right-1.5 bg-purple-600 text-white text-[9px] font-bold px-1.5 py-0.5 rounded-full">3</span>
            </div>
